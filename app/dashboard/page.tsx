  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Button size="lg" variant="outline" className="h-auto py-6 flex-col gap-2 bg-transparent">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            <p className="text-4xl font-bold">{mockUser.balance.toFixed(4)} BTC</p>
            <p className="text-2xl text-muted-foreground">${mockUser.balanceUSD.toLocaleString()}</p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">Your Bitcoin statistics will appear here.</p>
          </CardContent>
        </Card>
      </div>
    </div>
